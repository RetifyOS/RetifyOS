 ...
 * repo — Aetheria surfaced strategies as Telegram text, RetifyOS has a console,
 ...
 */
export function strategyView(row) {
    const p = row.params;
...
export function strategyMint(row) {
