 ...
 */
import { quoteBucketFor } from "../kernel/money.js";
const ZERO = { sol: 0n, usdc: 0n };
/** An exposure snapshot that every opening guard will refuse. Use whenever a read fails. */
export function staleExposure(reason) {
    return {
        openPositions: 0,
...
export function exposureFrom(positions) {
    const notional = { sol: 0n, usdc: 0n };
    const collateral = { sol: 0n, usdc: 0n };
    let unbucketed = 0;
...
export function positionIn(positions, symbol) {
