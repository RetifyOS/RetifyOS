 ...
 */
export function makePerpsOpenTool(deps) {
    return {
        name: "perps_open",
        category: "perps",
        description: "Propose opening a leveraged perp position. Margin is the input leg and is capped by policy. Builds an intent for the kernel; never executes.",
